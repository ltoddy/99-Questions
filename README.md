<h2 align="center">H-99: Ninety-Nine Haskell Problems</h2>
<div align="center">
...
|-----------------------------------|
|[Define predicates and/2, or/2, nand/2, nor/2, xor/2, impl/2 and equ/2 (for logical equivalence) which succeed or fail according to the result of their respective operations; e.g. and(A,B) will succeed, if and only if both A and B succeed.](src/Problem046.hs)|
|[Truth tables for logical expressions (2).](src/Problem047.hs)|
